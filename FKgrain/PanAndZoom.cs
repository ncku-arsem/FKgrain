...
namespace FKgrain {
    public class PanAndZoom : PictureBox {
        ...
        private void SetScrollBarVisibilityAndMaxMin() {
            ...
            if (horizontalScrollBar.Visible) {  // If the offset does not make the Maximum less than zero, set its value.            
            ...
            if (verticalScrollBar.Visible) {  // If the offset does not make the Maximum less than zero, set its value.            
